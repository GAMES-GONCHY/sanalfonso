...
//             var stackedAreaChart = nv.models.stackedAreaChart().useInteractiveGuideline(true).x(function(d) {
//                 return d[0]
//             }).y(function(d) {
//                 return d[1]
//             }).pointSize(0.5).margin({
//                 'left': 35,
//                 'right': 25,
//                 'top': 20,
//                 'bottom': 20
//             }).controlLabels({
//                 stacked: 'Stacked'
//             }).showControls(false).duration(300);
...
//             d3.select('#visitors-line-chart').append('svg').datum(visitorAreaChartData).transition().duration(1000).call(stackedAreaChart).each('start', function() {
//                 setTimeout(function() {
        ...
        success: function(response) {
            ...
            if ($('#visitors-line-chart').length !== 0) {
                nv.addGraph(function() {
                    ...
                    // Configuración del eje X para mostrar solo los meses
