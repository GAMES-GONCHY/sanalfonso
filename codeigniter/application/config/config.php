...
|
*/
//$config['base_url'] = 'http://localhost/terceranio/mvcNew/codeigniter/';//aqui copiamos la direccion base con localhost en lugar de los corchetes
//la direccion base finaliza con un slash


//estas 2 lineas de codigo detectan automaticamente la direccion URL base OJO
...
|
*/
$config['encryption_key'] = 'Decode';//definicion de una llave de encriptacion
...
$config['sess_expiration'] = 7200;//duracion de la sesion
